...
public class ShutDownHandler implements SignalHandler {
    ...
    private static ShutDownHandleInterface handleInterface;
    ...
    public void handle(Signal signal) {
        if (signal.getName().equals("TERM") || signal.getName().equals("INT") || signal.getName().equals("HUP")) {
